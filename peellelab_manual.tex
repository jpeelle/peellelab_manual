...
\item A David Mahoney Neuroimaging Grant from the \href{http://dana.org}{Dana Foundation} to look at relationship of age, hearing, and cognitive factors in speech comprehension. (This grant is ended but analyses are ongoing---and why you will hear about ``the Dana project''.)
\end{itemize}
...
At the outset of your capstone project, please make a check list with planned due dates (see Table \ref{table:deadlines}), and keep this updated throughout the year.
...
At the outset of your honors project, please make a check list with planned due dates (see Table \ref{table:deadlines}), and keep this updated throughout the year.
...
We are working towards putting all stimuli, data, and analyses online and linked to each research publication. The idea is not ti simply tick a box of ``open science'', but to make these resources readable and useable for reviewers and other researchers. In service of this:
