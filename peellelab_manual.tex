...
\author{Jonathan Peelle\\Center for Cognitive and Brain Health\\Department of Communication Sciences and Disorders\\Department of Psychology\\Northeastern University\\ \url{http://peellelab.org/peellelab_manual.pdf}}
\date{\today}
...
\textbf{(Note that the lab manual is slowly being updated to reflect the Peelle Lab move to Northeastern University. Some information my no longer be applicable.)}


%You can also find the lab elsewhere:
%
%\begin{itemize}
...
\begin{itemize}
\item R01 DC019507 from \href{http://www.nidcd.nih.gov}{NIDCD}, ``Individual differences in brain networks supporting speech understanding in patients with cochlear implants''. 

\item R01 DC017451 from NIDCD, ``Measurement of individualized factors associated with tinnitus burden'' (PI: Piccirillo).

\item R01 DC016594 from NIDCD, ``Audio-visual integration, age, and hearing loss''' (PI: Tye-Murray). 
...
\section{Collaborators at Washington University}
\begin{itemize}
...
There are many resources and benefits available through human resources. These are spelled out to some degree on the website, and I can also put you in touch with people in the department or HR who can offer guidance.
...
Important guidance on benefits and policies (including time off policies) is available through Human Resources. It is important that these policies are followed at all times. You are responsible for reviewing the policies and benefits; human resources is a good resource and they can help you if you have any questions. If you have any questions please speak with me.

\subsection{Sexual harassment}
University policy requires that if any faculty member (such as me) becomes aware of sexual harassment or abuse involving students or employees we must report it to the Title IX Sexual Harassment Response Coordinator (\url{https://www.northeastern.edu/ouec/}). Counselors and other medical professionals on campus who discuss these issues in their professional capacity can keep patient confidentiality.
...
We meet weekly to talk about science together, and to make sure we have a chance to touch base on administrative and practical issues. There may even be a snack. Regular attendance and participation is expected (unless you have a class or clinical responsibilities during that time).
...
\item Answer the phone, and return all phone calls (and emails) promptly. Tell participants who you are, and where you are calling from: ``Hello, this is [name] calling from the Peelle Lab at Northeastern University. I am returning your call from yesterday regarding a research study.''
...
\begin{itemize}
\item Always use a title (Dr./Ms./Mr.) and a participant's last name when addressing them. If you aren't sure how to pronounce their name, ask them. (You can also ask them which title they prefer.)
\end{itemize}
